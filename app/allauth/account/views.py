...
class RedirectAuthenticatedUserMixin(object):
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated() and \
            ...
            print '..RedirectAuthenticatedUserMixin...redirect to==',redirect_to
            ...
            # print 'response in RedirectAuthenticatedUserMixin=',str(response)
        return response
...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # print 'res dispatch=',str(res)
        print '...template_name in LoginView=',self.template_name
        return res
    ...
    def get_context_data(self, **kwargs):
        print '....get_context_data in Login allauth'
...
class SignupView(RedirectAuthenticatedUserMixin, CloseableSignupMixin,
    ...
    def get_context_data(self, **kwargs):
        print '...get context data in signup;'
